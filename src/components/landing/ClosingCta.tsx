...
/** Closing CTA: a gradient card on white, echoing the hero. Centered. */
export function ClosingCta() {
  return (
    <section className="container-content pb-20 lg:pb-28">
      <div className="relative overflow-hidden rounded-hero bg-mint-hero px-8 py-20 text-center shadow-hero">
